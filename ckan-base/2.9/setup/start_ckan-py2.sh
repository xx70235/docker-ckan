...
UWSGI_OPTS="--socket /tmp/uwsgi.sock --wsgi-file /srv/app/wsgi.py --module wsgi:application --uid 92 --gid 92 --http 0.0.0.0:30225 --master --enable-threads --lazy-apps -p 2 -L -b 32768 --vacuum --harakiri 50"
